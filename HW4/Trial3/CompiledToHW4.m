...
n = 64; % Number of points, so it's n - 1 intervals. 
AA = zeros(9, n^2, 5);  % To store all solutions.  
xs = linspace(-10, 10, n);
ys = linspace(-10, 10, n);

Params = Parameters(n, xs(2) - xs(1));
Params.l = 20;  % For fft.
...
% Notes: 
% 1. 
% Using the Modified Laplacian for computing the derivative of omega
% doesn't produce a lot of changes on the output of the matrix. 
% 2. 
